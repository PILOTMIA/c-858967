...
We will contact you with access details for the VIP Telegram group.`);
  ...
  const TermsAndConditions = () => (
    <ScrollArea className="h-96 w-full rounded-md border border-border bg-black p-4">
      <div className="space-y-4 text-sm text-foreground">
        <div>
          <h3 className="font-bold text-lg mb-2 text-foreground">Disclaimer:</h3>
        ...
        <div>
          <h3 className="font-bold text-base mb-2 text-foreground">Chart Analysis:</h3>
          <p className="mb-4 text-muted-foreground">
        ...
        <div>
          <h3 className="font-bold text-base mb-2 text-foreground">When to close trades:</h3>
          <p className="mb-4 text-muted-foreground">
        ...
        <div>
          <h3 className="font-bold text-base mb-2 text-foreground">Lot sizes:</h3>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto bg-black border-border">
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900 p-4 rounded-lg border border-border">
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <p className="text-foreground">Buy the VIP membership and you will have instant and easy access to our Forex, Cryptocurrency, Gold ideas and technical analysis.</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-400">💡</span>
                <p className="text-foreground">If you are a full-time trader, you would be able to use our experts' daily technical analysis for Forex pairs and Cryptocurrencies to find the best trading opportunities in order to save your time and increase your profit.</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-400">💡</span>
                <p className="text-foreground">If you are a student or you have any other jobs, or even if you don't have a lot experience in this market, by using the principles of money management and our technical analysis you would be able to make a second source of income for yourself.</p>
              </div>
            </div>
          </div>
          ...
          {/* Pricing Plans */}
          <div>
            <h3 className="text-lg font-bold mb-3 text-center text-foreground">🔽Premium Service Fee 🔽</h3>
              ...
              {membershipPlans.map((plan) => (
                <div
                  ...
                  className={`p-3 border rounded-lg cursor-pointer transition-all ${
                    form.watch("membershipTier") === plan.id
                      ...
                      : "border-border bg-gray-900 hover:border-gray-500"
                  }`}
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-xs text-muted-foreground">{plan.monthlyRate}</div>
                  </div>
                </div>
              ))}
            </div>
            <div className="text-center mt-3 space-y-1">
              <p className="text-sm text-muted-foreground">Payment method is through PayPal.</p>
              <a 
              ...
              <p className="text-xs text-muted-foreground">💠VIP members also can use the offer to extend their membership for the future as well.</p>
            </div>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Your full name" {...field} className="bg-muted border-border text-foreground placeholder:text-muted-foreground" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="your@email.com" type="email" {...field} className="bg-muted border-border text-foreground placeholder:text-muted-foreground" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Your phone number" {...field} className="bg-muted border-border text-foreground placeholder:text-muted-foreground" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-foreground">Trading Experience</FormLabel>
                    <FormControl>
                      <Textarea 
