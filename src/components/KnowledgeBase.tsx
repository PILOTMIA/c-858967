        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-800 p-4 rounded">
            ...
            <div className="flex justify-center mb-4">
              <img src="/lovable-uploads/b9a3ec60-ee05-48d3-bb19-280d08cb69ac.png" alt="Daily Timeframe Entry Strategy" className="max-w-full h-auto rounded border border-gray-600" />
            </div>
          ...
          <div className="bg-gray-800 p-4 rounded">
            ...
            <div className="flex justify-center mb-4">
              <img src="/lovable-uploads/d8d10dab-cf2b-44c9-b422-abf2ba1e7815.png" alt="4H Timeframe Entry Strategy" className="max-w-full h-auto rounded border border-gray-600" />
            </div>
            <p className="text-sm text-gray-300">
