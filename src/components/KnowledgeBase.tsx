  ...
  const knowledgeData: Record<string, KnowledgeItem> = {
    'triple-screen': {
      ...
      content: (
        <div className="space-y-4">
          <h3 className="text-lg font-bold text-green-400">The Three Screens</h3>
          
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-blue-400">Screen 1: Market Tide (Weekly)</h4>
          ...
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-blue-400">Screen 2: Market Wave (Daily)</h4>
            <p className="text-sm text-muted-foreground mt-2">
          ...
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-blue-400">Screen 3: Market Ripple (Intraday)</h4>
            <p className="text-sm text-muted-foreground mt-2">
    ...
    'entry-strategies': {
      ...
      content: (
        <div className="space-y-6">
          <h3 className="text-lg font-bold text-green-400">Professional Entry Strategies</h3>
          
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-blue-400 mb-3">Daily Time Frame Strategy</h4>
            <div className="flex justify-center mb-4">
              <img src="/lovable-uploads/b9a3ec60-ee05-48d3-bb19-280d08cb69ac.png" alt="Daily Timeframe Entry Strategy" className="max-w-full h-auto rounded border border-border" />
            </div>
          ...
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-blue-400 mb-3">4-Hour Time Frame Strategy</h4>
            <div className="flex justify-center mb-4">
              <img src="/lovable-uploads/d8d10dab-cf2b-44c9-b422-abf2ba1e7815.png" alt="4H Timeframe Entry Strategy" className="max-w-full h-auto rounded border border-border" />
            </div>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="bg-yellow-900/30 border border-yellow-500/50 p-4 rounded">
            <h4 className="font-bold text-yellow-400">Key Entry Rules</h4>
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-red-900/30 border border-red-500/50 p-4 rounded">
            <h4 className="font-bold text-red-400">The 2% Rule</h4>
            <p className="text-sm text-muted-foreground mt-2">
          ...
          <div className="bg-yellow-900/30 border border-yellow-500/50 p-4 rounded">
            <h4 className="font-bold text-yellow-400">The 6% Rule</h4>
            <p className="text-sm text-muted-foreground mt-2">
          ...
          <div className="bg-green-900/30 border border-green-500/50 p-4 rounded">
            <h4 className="font-bold text-green-400">Position Sizing Formula</h4>
            <p className="text-sm text-muted-foreground mt-2">
    ...
    'psychology': {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-purple-400">The Deadly Emotions</h4>
            <ul className="text-sm text-muted-foreground mt-2 space-y-1">
          ...
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-purple-400">Discipline Rules</h4>
            <ul className="text-sm text-muted-foreground mt-2 space-y-1">
    ...
    'indicators': {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-cyan-400">MACD-Histogram</h4>
            <p className="text-sm text-muted-foreground mt-2">
          ...
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-cyan-400">Force Index</h4>
            <p className="text-sm text-muted-foreground mt-2">
          ...
          <div className="bg-muted p-4 rounded">
            <h4 className="font-bold text-cyan-400">Elder-Ray (Bull & Bear Power)</h4>
            <p className="text-sm text-muted-foreground mt-2">
    ...
    <Card className="bg-gray-900 border-border">
      <CardHeader>
        <CardTitle className="text-foreground flex items-center gap-2">
          ...
          <span className="text-sm text-muted-foreground font-normal">Based on "Trading for a Living"</span>
        </CardTitle>
      </CardHeader>
      <CardContent>
