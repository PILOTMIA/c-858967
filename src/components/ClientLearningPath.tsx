      ...
      <div className="bg-muted p-6 rounded-xl border border-border">
        ...
        <div className="space-y-3 mb-4">
          {steps.map((step) => (
            <div 
              key={step.id}
              className="flex items-start gap-3 p-3 rounded-lg bg-gray-900 border border-border cursor-pointer hover:border-gray-500 transition-colors"
            ...
            >
              ...
              <div className="flex-1">
                <h4 className={`font-semibold text-sm ${step.completed ? 'text-green-400' : 'text-foreground'}`}>
                  {step.title}
                </h4>
        ...
        <div className="flex gap-2">
          ...
          <Button 
            ...
            variant="outline" 
            className="border-border text-muted-foreground hover:bg-accent text-sm"
          >
