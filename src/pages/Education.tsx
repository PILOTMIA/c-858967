    ...
    <div className="min-h-screen bg-black p-2 sm:p-4">
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Education Center</h1>
          <p className="text-sm sm:text-base text-gray-300">Learn forex trading with our comprehensive resources</p>
        </div>
        ...
        {/* Trading Quiz Game */}
        <div className="mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4 text-center">🎮 Test Your Trading Knowledge</h2>
